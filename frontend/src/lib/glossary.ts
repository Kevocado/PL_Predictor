...
export const GLOSSARY = {
  ...
  trackRecordScore:
    "Whether the model's highest-probability result (home win / draw / away win) matched what actually happened — computed only on predictions logged before kickoff and since resolved against the real result. Picks rebuilt after kickoff are listed but not counted. Not a backtest on old seasons: a live, ongoing record.",
  trackRecordByMarket:
